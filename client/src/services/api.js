...
export async function listSupplierParts(id){ const { data } = await api.get(`/suppliers/${id}/parts`); return data; }
...
/* BOM Templates + Apply/Clone (if you’re using them) */
